...
class TblPeralatan extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['permohonan_id', 'alat_nama', 'alat_kodAkaun', 'alat_kuantiti', 'alat_hargaUnit', 'alat_jumlahHarga', 'jk_id', 'katPelanggan_id', 'alat_tujuan', 'katPermohonan_id', 'alat_jenisPeruntukan', 'alat_programBaru', 'alat_tahap', 'tahunSedia_id', 'alat_pegawai', 'alat_jawatan', 'alat_lokasi', 'alat_bukuLog', 'bukuLog_id', 'deleteBukuLog', 'sort_order'], 'required'],
            ...
            [['alat_nama', 'alat_kodAkaun', 'alat_tujuan', 'alat_jenisPeruntukan', 'alat_programBaru', 'alat_tahap', 'alat_pegawai', 'alat_jawatan', 'alat_lokasi', 'alat_bukuLog'], 'string', 'max' => 200],

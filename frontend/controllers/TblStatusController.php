...
use frontend\models\TblStatusSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * TblStatusController implements the CRUD actions for TblStatus model.
 */
class TblStatusController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new TblStatusSearch();

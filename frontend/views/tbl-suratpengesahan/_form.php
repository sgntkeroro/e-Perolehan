...
<div class="tbl-suratpengesahan-form">
    ...
    <div class="col-lg-3">
        <?= $form->field($model, 'suratSah_nama')->fileInput() ?>
    </div>
    <div class="col-lg-3">
        <?= $form->field($model, 'suratSah_tarikh')->textInput(['readonly' => true, 'value'=>date('Y-m-d')]) ?>
    </div>
    <div class="col-lg-6">
        <?= $form->field($model, 'suratSah_deskripsi')->textArea(['maxlength' => true]) ?>
    </div> 

...
/**
 * TblSuratpengesahanSearch represents the model behind the search form about `frontend\models\TblSuratpengesahan`.
 */
class TblSuratpengesahanSearch extends TblSuratpengesahan
{
    ...
    public function search($params)
    {
        ...
        ->innerjoin ('tbl_permohonan', 'tbl_permohonan.permohonan_id = tbl_suratpengesahan.permohonan_id')

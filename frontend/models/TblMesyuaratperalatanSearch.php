...
/**
 * TblMesyuaratperalatanSearch represents the model behind the search form about `frontend\models\TblMesyuaratperalatan`.
 */
class TblMesyuaratperalatanSearch extends TblMesyuaratperalatan
{
    ...
    {
        return [
            [['mesy_id', 'mesyPerm_id', 'alat_id', 'mesy_kuantiti'], 'integer'],
